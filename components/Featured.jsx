  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.post}>
        ...
        <Image src='/27.jpg' alt='' fill/>
        </div>
        <div className={styles.textContainer}>
          <h2>Let's Practice Meditation</h2>
          <p>Meditation provides a tranquil escape from the daily chaos, offering a chance to delve inward and find serenity. Through focused attention on the breath, it fosters mindfulness, heightening awareness of thoughts and emotions. With regular practice, meditation becomes a valuable tool for stress management and mental clarity. Universally accessible, it transcends boundaries, offering solace and insight to all seekers. In its quiet depths, meditation unveils a sanctuary of inner peace and self-discovery.</p>
